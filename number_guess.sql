...
--
-- Name: user_stats user_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--
...
INSERT INTO public.user_stats VALUES (1, 'jacob', 0, NULL);
...
SELECT pg_catalog.setval('public.user_stats_user_id_seq', 1, true);
